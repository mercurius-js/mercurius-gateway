...
// ----------------------
describe('onGatewayReplaceSchema', () => {
  let clock
  ...
  test('polling interval with a new schema should trigger onGatewayReplaceSchema hook', async t => {
    const resolvers = {
      Query: {
        me: () => user
      },
  ...
  test('should log an error should any errors occur in the hook', async t => {
    const resolvers = {
      Query: {
        me: () => user
      },
